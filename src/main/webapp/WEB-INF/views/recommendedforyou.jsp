...
<title><fmt:message key="recommendedforyou"/></title>
...
<link href="resources/css/star-rating/theme-krajee-svg.css" media="all"
	rel="stylesheet" type="text/css" />
<link href="resources/css/recommendedforyou.css" rel="stylesheet">
...
<body>
	...
	<div class="container" style="padding-left:15%">
		<div class="row" style="padding-bottom:3%">
			<div class="col-md-12">
				<h1>
					<fmt:message key="recommendedforyou" />
				</h1>
			</div>
		</div>
		...
		<div id="page-wrapper">
			...
			<c:forEach items="${recommendedcourses}" var="course" varStatus="i">
